...
def generate_testnet_dry_run_readiness_report(
    *,
    ...
    output_dir: str = "reports/testnet_dry_run_readiness",
) -> dict[str, Any]:
    ...
    report_json = out_dir / "testnet_dry_run_readiness_report.json"
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate final readiness report for entering testnet dry-run phase")
    ...
    parser.add_argument("--output-dir", default="reports/testnet_dry_run_readiness")
...
def main() -> None:
    ...
    result = generate_testnet_dry_run_readiness_report(
        ...
        output_dir=str(args.output_dir or "reports/testnet_dry_run_readiness"),
    )
    if bool(args.json):
